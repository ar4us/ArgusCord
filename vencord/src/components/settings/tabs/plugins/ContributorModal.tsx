...
import { RenderModalProps, User } from "@arguscord/discord-types";
...
function ContributorModal({ user, modalProps }: { user: User; modalProps: RenderModalProps; }) {
    ...
    const ContributedHyperLink = <Link href="https://arguscord.dev/source">contributed</Link>;
        ...
        <Modal
            ...
            subtitle={
                plugins.length
                    ...
                    : (
                        <Forms.FormText>
                            This person has not made any plugins. They likely {ContributedHyperLink} to ArgusCord in other ways!
                        </Forms.FormText>
                    )
            }
        >
