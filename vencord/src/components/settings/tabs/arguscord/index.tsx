...
import { gitRemote } from "@shared/arguscordUserAgent";
            ...
            <section>
                ...
                <QuickActionCard>
                    ...
                    <QuickAction
                        Icon={PaintbrushIcon}
                        text="Edit QuickCSS"
                        action={() => ArgusCordNative.quickCss.openEditor()}
                    />
                    {!IS_WEB && (
                        <>
                            <QuickAction
                            ...
                            <QuickAction
                                ...
                                action={() => ArgusCordNative.settings.openFolder()}
                            />
                        </>
                    )}
                    <QuickAction
                        ...
                        action={() => ArgusCordNative.native.openExternal("https://github.com/ArgusCord/ArgusCord")}
                    />
                </QuickActionCard>
            </section>
...
export default wrapTab(ArgusCordSettings, "ArgusCord Settings");
