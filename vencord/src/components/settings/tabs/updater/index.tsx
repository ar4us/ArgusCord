...
function VesktopSection() {
    ...
    return (
        <Flex className={Margins.bottom20} flexDirection="column" gap="1em">
            <Card variant="info">
                <HeadingSecondary>Vesktop & ArgusCord</HeadingSecondary>
                <Paragraph>Vesktop and ArgusCord are two separate things. This updater is for ArgusCord.</Paragraph>
    ...
    return (
        <SettingsTab>
            ...
            <FormSwitch
                ...
                description="Automatically update ArgusCord without confirmation prompt"
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
            />
            <FormSwitch
                title="Get notified when an automatic update completes"
                description="Show a notification when ArgusCord automatically updates"
