    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: (match, args) => "" +
                    `async ${match}` +
                    `if(await ArgusCord.Api.MessageEvents._handlePreEdit(${args}))` +
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: (m, parsedMessage, channel, replyOptions, extra) => m +
                    `if(await ArgusCord.Api.MessageEvents._handlePreSend(${channel}.id,${parsedMessage},${extra},${replyOptions}))` +
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: (m, message, channel, event) =>
                    `const vcMsg=${message},vcChan=${channel};${m}ArgusCord.Api.MessageEvents._handleClick(vcMsg,vcChan,${event});`
            }
        }
    ]
});
