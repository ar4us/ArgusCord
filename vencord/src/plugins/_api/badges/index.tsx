...
const ContributorBadge: ProfileBadge = {
    id: "arguscord_contributor_badge",
    description: "ArgusCord Contributor",
...
async function loadBadges(noCache = false) {
    ...
    DonorBadges = await fetch("https://badges.arguscord.dev/badges.json", init)
        .then(r => r.json());
}
            ...
            onClick() {
                openModal(props => (
                    <ErrorBoundary noop onError={() => {
                        props.onClose();
                        ArgusCordNative.native.openExternal("https://github.com/sponsors/Vendicated");
                    }}>
                        <Modal
                            {...props}
                            title={
                        ...
                        >
                            <div>
                                ...
                                <div style={{ padding: "1em" }}>
                                    <Forms.FormText>
                                        This Badge is a special perk for ArgusCord Donors
                                    </Forms.FormText>
                                    <Forms.FormText className={Margins.top20}>
                                        Please consider supporting the development of ArgusCord by becoming a donor. It would mean a lot!!
                                    </Forms.FormText>
                                </div>
                            </div>
                            <div>
