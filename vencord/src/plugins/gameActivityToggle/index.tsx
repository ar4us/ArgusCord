...
import ArgusCordToolboxPlugin from "@plugins/arguscordToolbox";
...
const settings = definePluginSettings({
    ...
    location: {
        ...
        options: [
            ...
            { label: "ArgusCord Toolbox", value: "TOOLBOX" }
        ],
        get hidden() {
            return !isPluginEnabled(ArgusCordToolboxPlugin.name);
        }
    }
});
...
function GameActivityToggleButton(props: { nameplate?: any; }) {
    ...
    if (location !== "PANEL" && isPluginEnabled(ArgusCordToolboxPlugin.name)) return null;
