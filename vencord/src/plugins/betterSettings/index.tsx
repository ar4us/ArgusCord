...
import { buildPluginMenuEntries, buildThemeMenuEntries } from "@plugins/arguscordToolbox/menu";
...
export default definePlugin({
    ...
    patches: [
            ...
            replacement: [
                {
                    ...
                    replace: "var $1=$self.Layer;class ArgusCordPatchedOldFadeLayer",
        ...
        { // Load menu TOC eagerly
            ...
            replacement: {
                ...
                replace: "_arguscordBetterSettingsEagerLoad=(async ()=>$1)();"
            },
            predicate: () => settings.store.eagerLoad
        },
    ...
    Layer(props: LayerProps) {
        try {
            [FocusLock.$$arguscordGetWrappedComponent(), ComponentDispatch, Classes.layer].forEach(e => e.test);
        } catch {
    ...
    transformSettingsEntries(list) {
        ...
        for (const item of list) {
            ...
            if (key === "arguscord_plugins" || key === "arguscord_themes") {
                const children = key === "arguscord_plugins"
