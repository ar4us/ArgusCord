...
console.log("[ArgusCord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "ArgusCord");
    ...
    console.log("[ArgusCord] Running in vanilla mode. Not loading ArgusCord");
}

console.log("[ArgusCord] Loading original Discord app.asar");
