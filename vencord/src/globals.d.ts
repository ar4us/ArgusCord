...
declare global {
    ...
    export var ArgusCordNative: typeof import("./ArgusCordNative").default;
    export var ArgusCord: typeof import("./ArgusCord");
    export var ArgusCordStyles: Map<string, Style>;
