...
const sourceMapFooter = s => watch ? "" : `//# sourceMappingURL=arguscord://${s}.js.map`;
...
const buildConfigs = ([
    // Discord Desktop main & renderer & preload
    {
        ...
        footer: { js: "//# sourceURL=file:///ArgusCordPatcher\n" + sourceMapFooter("patcher") },
        sourcemap,
        plugins: [
    ...
    {
        ...commonOpts,
        entryPoints: ["src/ArgusCord.ts"],
        outfile: "dist/renderer.js",
        format: "iife",
        target: ["esnext"],
        footer: { js: "//# sourceURL=file:///ArgusCordRenderer\n" + sourceMapFooter("renderer") },
        globalName: "ArgusCord",
        sourcemap,
        plugins: [
    ...
    },
    {
        ...
        footer: { js: "//# sourceURL=file:///ArgusCordPreload\n" + sourceMapFooter("preload") },
        sourcemap,
        define: {
            ...defines,
            IS_DISCORD_DESKTOP: "true",
    ...
    // ArgusCord Desktop main & renderer & preload
    {
        ...nodeCommonOpts,
        entryPoints: ["src/main/index.ts"],
        outfile: "dist/arguscordDesktopMain.js",
        footer: { js: "//# sourceURL=file:///ArgusCordDesktopMain\n" + sourceMapFooter("arguscordDesktopMain") },
        sourcemap,
        plugins: [
            ...nodeCommonOpts.plugins,
            globNativesPlugin
    ...
    },
    {
        ...commonOpts,
        entryPoints: ["src/ArgusCord.ts"],
        outfile: "dist/arguscordDesktopRenderer.js",
        format: "iife",
        target: ["esnext"],
        footer: { js: "//# sourceURL=file:///ArgusCordDesktopRenderer\n" + sourceMapFooter("arguscordDesktopRenderer") },
        globalName: "ArgusCord",
        sourcemap,
        plugins: [
            globPlugins("vesktop"),
    ...
    },
    {
        ...nodeCommonOpts,
        entryPoints: ["src/preload.ts"],
        outfile: "dist/arguscordDesktopPreload.js",
        footer: { js: "//# sourceURL=file:///ArgusCordPreload\n" + sourceMapFooter("arguscordDesktopPreload") },
        sourcemap,
        define: {
            ...defines,
            IS_DISCORD_DESKTOP: "false",
