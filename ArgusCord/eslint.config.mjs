...
export default tseslint.config(
    { ignores: ["dist", "browser", "packages/arguscord-types"] },
    {
    ...
    },
    {
        ...
        rules: {
            /*
             * Since it's only been a month and ArgusCord has already been stolen
            ...
            "simple-header/header": [
                "error",
                {
                    ...
                    "templates": { "author": [".*", "ar4us and contributors"] }
                }
            ],
