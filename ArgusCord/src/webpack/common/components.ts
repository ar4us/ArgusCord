...
import * as t from "@arguscord/discord-types";
...
export const Forms = {
    ...
    /** @deprecated use Heading from ArgusCord */
    FormTitle: Heading,
    /** @deprecated use Paragraph from ArgusCord */
    FormText: Paragraph,
...
/** @deprecated use Paragraph, Span, or BaseText from ArgusCord */
export const Text = TextCompat;
/** @deprecated use Button from ArgusCord */
export const Button = ButtonCompat;
/** @deprecated Use FormSwitch from ArgusCord */
...
/** @deprecated import from @arguscord/components */
