...
import { Command, FluxEvents } from "@arguscord/discord-types";
...
export interface PluginDef {
    ...
    /**
     * Allows you to add custom actions to the ArgusCord Toolbox.
     *
...
export const enum StartAt {
    /** Right away, as soon as ArgusCord initialised */
    Init = "Init",
