...
export default definePlugin({
    ...
    patches: [
        {
            ...
            replacement: {
                ...
                // react.jsx(WrapperComponent, { ArgusCordOriginal: AccountPanel, ...
                replace: "$self.PanelWrapper,{ArgusCordOriginal:$1,"
            }
        },
        {
            find: ".PLAYER_DEVICES",
    ...
    PanelWrapper({ ArgusCordOriginal, ...props }) {
        return (
            <>
                <ErrorBoundary
                    fallback={() => (
