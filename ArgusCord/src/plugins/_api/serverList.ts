    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: "[$1].concat(ArgusCord.Api.ServerList.renderAll(ArgusCord.Api.ServerList.ServerListRenderPosition.Above))"
            }
        },
        {
            find: ".setGuildsTree(",
            replacement: {
                ...
                replace: "ArgusCord.Api.ServerList.renderAll(ArgusCord.Api.ServerList.ServerListRenderPosition.In).concat($&)"
            }
        }
    ]
});
