...
import type { Channel, Embed, GuildMember, MessageAttachment, User } from "@arguscord/discord-types";
...
async function start() {
    ...
    socket = new WebSocket(`ws://127.0.0.1:${settings.store.webSocketPort ?? 42070}/?client=ArgusCord`);
...
const Native = ArgusCordNative.pluginHelpers.XSOverlay as PluginNative<typeof import("./native")>;
