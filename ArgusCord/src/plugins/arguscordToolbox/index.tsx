...
function ArgusCordPopoutButton() {
        ...
        >
            {(_, { isShown }) => (
                <HeaderBarIcon
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "ArgusCord Toolbox"}
...
export default definePlugin({
    name: "ArgusCordToolbox",
    description: "Adds a button to the titlebar that houses ArgusCord quick actions",
